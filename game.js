function buildSceneGraph (SGraph) {
    ...
    SGraph.lightsManager.addSource (new light (new transform (vec3.fromValues (0.0, 12.5, -16.0), vec3.fromValues (1.0, 1.0, 1.0), quat.create ()),
                                               vec3.fromValues (0.0, -4.0, 32.0),
